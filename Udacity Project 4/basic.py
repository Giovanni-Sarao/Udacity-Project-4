...
category_1 = Categories(name="INFORMATION TECHNOLOGY")

session.add(category_1)
session.commit()

category_2 = Categories(name="Trips")
...
category_7 = Categories(name="Turbine")
